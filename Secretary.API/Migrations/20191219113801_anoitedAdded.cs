...
{
    public partial class anoitedAdded : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            //     name: "AssistenciaReuniao_Id_seq");

            // migrationBuilder.CreateSequence(
            //     name: "Congregacao_Id_seq");

            // migrationBuilder.CreateSequence(
            //     name: "Country_Id_seq");

            // migrationBuilder.CreateSequence(
            //     name: "Dianteira_Id_seq");
            ...
            // migrationBuilder.CreateSequence(
            //     name: "Familiares_Id_seq");

            // migrationBuilder.CreateSequence(
            //     name: "Grupo_Id_seq");

            // migrationBuilder.CreateSequence(
            //     name: "PeticaoPioneiroAuxiliar_Id_seq");

            // migrationBuilder.CreateSequence(
            //     name: "Pioneiro_Id_seq");

            // migrationBuilder.CreateSequence(
            //     name: "PrivilegioCongregacional_Id_seq");

            // migrationBuilder.CreateSequence(
            //     name: "Publicador_Id_seq");

            // migrationBuilder.CreateSequence(
            //     name: "PublicadorHistorico_Id_seq");

            // migrationBuilder.CreateSequence(
            //     name: "PublicadorPrivilegios_Id_seq");

            // migrationBuilder.CreateSequence(
            //     name: "PublicadorUsuario_Id_seq");
            ...
            // migrationBuilder.CreateSequence(
            //     name: "ServicoCampo_Id_seq");

            // migrationBuilder.CreateSequence(
            //     name: "ServicoCampod_Id_seq");

            // migrationBuilder.CreateSequence(
            //     name: "ServicoCampos_Id_seq");

            // migrationBuilder.CreateSequence(
            //     name: "ServicoCampot_Id_seq");

            // migrationBuilder.CreateSequence(
            //     name: "Situacao_Id_seq");

            // migrationBuilder.CreateSequence(
            //     name: "TipoLogradouro_Id_seq");

            // migrationBuilder.CreateSequence(
            //     name: "Transferencia_Id_seq");
            ...
            //     columns: table => new
            //     {
            //         Id = table.Column<long>(nullable: false, defaultValueSql: "nextval('secretary.\"Country_Id_seq\"'::regclass)"),
            ...
            //     columns: table => new
            //     {
            //         Id = table.Column<long>(nullable: false, defaultValueSql: "nextval('secretary.\"TipoLogradouro_Id_seq\"'::regclass)"),
            //         DateCreated = table.Column<DateTime>(type: "timestamp(3) without time zone", nullable: false, defaultValueSql: "now()"),
            //         ModifiedDate = table.Column<DateTime>(nullable: false, defaultValueSql: "now()"),
            //         IPAddress = table.Column<string>(nullable: true),
            ...
            //     columns: table => new
            //     {
            //         Id = table.Column<long>(nullable: false, defaultValueSql: "nextval('secretary.\"Estado_Id_seq\"'::regclass)"),
            //         DateCreated = table.Column<DateTime>(type: "timestamp(3) without time zone", nullable: false, defaultValueSql: "now()"),
            //         ModifiedDate = table.Column<DateTime>(nullable: false, defaultValueSql: "now()"),
            //         IPAddress = table.Column<string>(nullable: true),
            //         AuditoriaUsuario = table.Column<long>(nullable: false, defaultValueSql: "1"),
            ...
            //     columns: table => new
            //     {
            //         Id = table.Column<long>(nullable: false, defaultValueSql: "nextval('secretary.\"Congregacao_Id_seq\"'::regclass)"),
            //         DateCreated = table.Column<DateTime>(nullable: false, defaultValueSql: "now()"),
            //         ModifiedDate = table.Column<DateTime>(nullable: false, defaultValueSql: "now()"),
            //         IPAddress = table.Column<string>(nullable: true),
            //         AuditoriaUsuario = table.Column<long>(nullable: false, defaultValueSql: "1"),
            ...
            //     columns: table => new
            //     {
            //         Id = table.Column<long>(nullable: false, defaultValueSql: "nextval('secretary.\"Dianteira_Id_seq\"'::regclass)"),
            //         DateCreated = table.Column<DateTime>(type: "timestamp(3) without time zone", nullable: false, defaultValueSql: "now()"),
            //         ModifiedDate = table.Column<DateTime>(nullable: false, defaultValueSql: "now()"),
            //         IPAddress = table.Column<string>(nullable: true),
            //         AuditoriaUsuario = table.Column<long>(nullable: false, defaultValueSql: "1"),
            //         Descricao = table.Column<string>(maxLength: 255, nullable: false),
            //         CongregacaoId = table.Column<long>(nullable: false, defaultValueSql: "1")
            //     },
            //     constraints: table =>
            //     {
            ...
            //     columns: table => new
            //     {
            //         Id = table.Column<long>(nullable: false, defaultValueSql: "nextval('secretary.\"Pioneiro_Id_seq\"'::regclass)"),
            //         DateCreated = table.Column<DateTime>(type: "timestamp(3) without time zone", nullable: false, defaultValueSql: "now()"),
            //         ModifiedDate = table.Column<DateTime>(nullable: false, defaultValueSql: "now()"),
            //         IPAddress = table.Column<string>(nullable: true),
            //         AuditoriaUsuario = table.Column<long>(nullable: false, defaultValueSql: "1"),
            ...
            //     columns: table => new
            //     {
            //         Id = table.Column<long>(nullable: false, defaultValueSql: "nextval('secretary.\"PrivilegioCongregacional_Id_seq\"'::regclass)"),
            //         DateCreated = table.Column<DateTime>(type: "timestamp(3) without time zone", nullable: false, defaultValueSql: "now()"),
            //         ModifiedDate = table.Column<DateTime>(nullable: false, defaultValueSql: "now()"),
            //         IPAddress = table.Column<string>(nullable: true),
            //         AuditoriaUsuario = table.Column<long>(nullable: false, defaultValueSql: "1"),
            ...
            //     columns: table => new
            //     {
            //         Id = table.Column<long>(nullable: false, defaultValueSql: "nextval('secretary.\"PublicadorUsuario_Id_seq\"'::regclass)"),
            //         DateCreated = table.Column<DateTime>(nullable: false, defaultValueSql: "now()"),
            //         ModifiedDate = table.Column<DateTime>(nullable: false, defaultValueSql: "now()"),
            //         IPAddress = table.Column<string>(nullable: true),
            ...
            //     columns: table => new
            //     {
            //         Id = table.Column<long>(nullable: false, defaultValueSql: "nextval('secretary.\"Reuniao_Id_seq\"'::regclass)"),
            //         DateCreated = table.Column<DateTime>(type: "timestamp(3) without time zone", nullable: false, defaultValueSql: "now()"),
            //         ModifiedDate = table.Column<DateTime>(nullable: false, defaultValueSql: "now()"),
            //         IPAddress = table.Column<string>(nullable: true),
            //         AuditoriaUsuario = table.Column<long>(nullable: false, defaultValueSql: "1"),
            //         Descricao = table.Column<string>(maxLength: 255, nullable: false),
            //         DiaSemana = table.Column<string>(maxLength: 50, nullable: false, defaultValueSql: "1"),
            ...
            //     columns: table => new
            //     {
            //         Id = table.Column<long>(nullable: false, defaultValueSql: "nextval('secretary.\"Situacao_Id_seq\"'::regclass)"),
            //         DateCreated = table.Column<DateTime>(type: "timestamp(3) without time zone", nullable: false, defaultValueSql: "now()"),
            //         ModifiedDate = table.Column<DateTime>(nullable: false, defaultValueSql: "now()"),
            //         IPAddress = table.Column<string>(nullable: true),
            //         AuditoriaUsuario = table.Column<long>(nullable: false, defaultValueSql: "1"),
            ...
            //     columns: table => new
            //     {
            //         Id = table.Column<long>(nullable: false, defaultValueSql: "nextval('secretary.\"AssistenciaReuniao_Id_seq\"'::regclass)"),
            //         DateCreated = table.Column<DateTime>(nullable: false, defaultValueSql: "now()"),
            //         ModifiedDate = table.Column<DateTime>(nullable: false, defaultValueSql: "now()"),
            //         IPAddress = table.Column<string>(nullable: true),
            //         AnoReferencia = table.Column<int>(nullable: true),
            //         AuditoriaUsuario = table.Column<long>(nullable: false, defaultValueSql: "1"),
            //         DataReferencia = table.Column<DateTime>(type: "timestamp(3) without time zone", nullable: false, defaultValueSql: "now()"),
            ...
            //         ReuniaoId = table.Column<long>(nullable: false, defaultValueSql: "1"),
            //         CongregacaoId = table.Column<long>(nullable: false, defaultValueSql: "1")
            //     },
            //     constraints: table =>
            //     {
            ...
            //     columns: table => new
            //     {
            //         Id = table.Column<long>(nullable: false, defaultValueSql: "nextval('secretary.\"Recibo_Id_seq\"'::regclass)"),
            //         DateCreated = table.Column<DateTime>(type: "timestamp(3) without time zone", nullable: false, defaultValueSql: "now()"),
            //         ModifiedDate = table.Column<DateTime>(nullable: false, defaultValueSql: "now()"),
            //         IPAddress = table.Column<string>(nullable: true),
            //         AnoMesReferencia = table.Column<int>(nullable: false),
            //         AuditoriaUsuario = table.Column<long>(nullable: false),
            //         Data = table.Column<DateTime>(type: "timestamp(3) without time zone", nullable: false),
            ...
            //     columns: table => new
            //     {
            //         Id = table.Column<long>(nullable: false, defaultValueSql: "nextval('secretary.\"Familia_Id_seq\"'::regclass)"),
            //         DateCreated = table.Column<DateTime>(type: "timestamp(3) without time zone", nullable: false, defaultValueSql: "now()"),
            //         ModifiedDate = table.Column<DateTime>(nullable: false, defaultValueSql: "now()"),
            //         IPAddress = table.Column<string>(nullable: true),
            //         AuditoriaUsuario = table.Column<long>(nullable: false),
            ...
            //     columns: table => new
            //     {
            //         Id = table.Column<long>(nullable: false, defaultValueSql: "nextval('secretary.\"Familiares_Id_seq\"'::regclass)"),
            //         DateCreated = table.Column<DateTime>(type: "timestamp(3) without time zone", nullable: false, defaultValueSql: "now()"),
            //         ModifiedDate = table.Column<DateTime>(nullable: false, defaultValueSql: "now()"),
            //         IPAddress = table.Column<string>(nullable: true),
            //         AuditoriaUsuario = table.Column<long>(nullable: false),
            ...
            //     columns: table => new
            //     {
            //         Id = table.Column<long>(nullable: false, defaultValueSql: "nextval('secretary.\"Grupo_Id_seq\"'::regclass)"),
            //         DateCreated = table.Column<DateTime>(type: "timestamp(3) without time zone", nullable: false, defaultValueSql: "now()"),
            //         ModifiedDate = table.Column<DateTime>(nullable: false, defaultValueSql: "now()"),
            //         IPAddress = table.Column<string>(nullable: true),
            //         AuditoriaUsuario = table.Column<long>(nullable: false, defaultValueSql: "1"),
            ...
            //     columns: table => new
            //     {
            //         Id = table.Column<long>(nullable: false, defaultValueSql: "nextval('secretary.\"Publicador_Id_seq\"'::regclass)"),
            //         DateCreated = table.Column<DateTime>(type: "timestamp(3) without time zone", nullable: false, defaultValueSql: "now()"),
            //         ModifiedDate = table.Column<DateTime>(nullable: false, defaultValueSql: "now()"),
            //         IPAddress = table.Column<string>(nullable: true),
            //         AuditoriaUsuario = table.Column<long>(nullable: false, defaultValueSql: "1"),
            //         Bairro = table.Column<string>(maxLength: 255, nullable: true),
            //         Batismo = table.Column<DateTime>(type: "timestamp(3) without time zone", nullable: true),
            //         Cep = table.Column<string>(maxLength: 255, nullable: true),
            //         ChefeFamilia = table.Column<bool>(nullable: false),
            //         Cidade = table.Column<string>(maxLength: 255, nullable: true),
            //         Complemento = table.Column<string>(maxLength: 255, nullable: true),
            //         DataAnciao = table.Column<DateTime>(type: "timestamp(3) without time zone", nullable: true),
            //         DataInativo = table.Column<DateTime>(type: "timestamp(3) without time zone", nullable: true),
            //         DataInicioServico = table.Column<DateTime>(type: "timestamp(3) without time zone", nullable: true),
            //         DataNascimento = table.Column<DateTime>(type: "timestamp(3) without time zone", nullable: true),
            //         DataReativado = table.Column<DateTime>(type: "timestamp(3) without time zone", nullable: true),
            //         DataServoMinisterial = table.Column<DateTime>(type: "timestamp(3) without time zone", nullable: true),
            //         DianteiraId = table.Column<long>(nullable: true),
            //         Email = table.Column<string>(maxLength: 255, nullable: false),
            //         EstadoId = table.Column<long>(nullable: true),
            //         CountryId = table.Column<long>(nullable: false, defaultValueSql: "30"),
            //         GrupoId = table.Column<long>(nullable: true),
            //         IrmaoBatizado = table.Column<bool>(nullable: false),
            //         Login = table.Column<string>(maxLength: 255, nullable: true),
            //         Nome = table.Column<string>(maxLength: 255, nullable: false),
            //         Anointed = table.Column<bool>(nullable: false),
            //         NomeLogradouro = table.Column<string>(maxLength: 255, nullable: true),
            ...
            //         SituacaoId = table.Column<long>(nullable: false, defaultValueSql: "1"),
            //         SituacaoServicoCampo = table.Column<string>(maxLength: 9, nullable: false, defaultValueSql: "'Irregular'::character varying"),
            //         TelCelular = table.Column<string>(maxLength: 255, nullable: true),
            //         TelResidencial = table.Column<string>(maxLength: 255, nullable: true),
            //         TelTrabalho = table.Column<string>(maxLength: 255, nullable: true),
            //         TipoLogradouroId = table.Column<long>(nullable: true),
            //         InicioPioneiro = table.Column<DateTime>(type: "timestamp(3) without time zone", nullable: true),
            ...
            //             onDelete: ReferentialAction.Cascade);
            //         table.ForeignKey(
            //             name: "publicador$FK_Publicador_Country",
            //             column: x => x.CountryId,
            //             principalSchema: "secretary",
            //             principalTable: "Country",
            //             principalColumn: "Id",
            ...
            //     columns: table => new
            //     {
            //         Id = table.Column<long>(nullable: false, defaultValueSql: "nextval('secretary.\"PeticaoPioneiroAuxiliar_Id_seq\"'::regclass)"),
            //         DateCreated = table.Column<DateTime>(nullable: false, defaultValueSql: "now()"),
            //         ModifiedDate = table.Column<DateTime>(nullable: false, defaultValueSql: "now()"),
            //         IPAddress = table.Column<string>(nullable: true),
            ...
            //         EstaAprovado = table.Column<bool>(nullable: false),
            //         Observacao = table.Column<string>(maxLength: 255, nullable: true)
            //     },
            //     constraints: table =>
            //     {
            ...
            //     columns: table => new
            //     {
            //         Id = table.Column<long>(nullable: false, defaultValueSql: "nextval('secretary.\"PublicadorHistorico_Id_seq\"'::regclass)"),
            //         DateCreated = table.Column<DateTime>(nullable: false, defaultValueSql: "now()"),
            //         ModifiedDate = table.Column<DateTime>(nullable: false, defaultValueSql: "now()"),
            //         IPAddress = table.Column<string>(nullable: true),
            //         DataReferencia = table.Column<DateTime>(type: "timestamp(3) without time zone", nullable: false),
            ...
            //     columns: table => new
            //     {
            //         Id = table.Column<long>(nullable: false, defaultValueSql: "nextval('secretary.\"PublicadorPrivilegios_Id_seq\"'::regclass)"),
            //         DateCreated = table.Column<DateTime>(nullable: false, defaultValueSql: "now()"),
            //         ModifiedDate = table.Column<DateTime>(nullable: false, defaultValueSql: "now()"),
            //         IPAddress = table.Column<string>(nullable: true),
            //         PrivilegioCongregacionalId = table.Column<long>(nullable: false, defaultValueSql: "15"),
            //         CongregacaoId = table.Column<long>(nullable: false, defaultValueSql: "1"),
            //         PublicadorId = table.Column<long>(nullable: false, defaultValueSql: "1")
            //     },
            //     constraints: table =>
            //     {
            ...
            //             onDelete: ReferentialAction.Cascade);
            //         table.ForeignKey(
            //             name: "publicador_privilegios$FK_PublicadorPrivilegios_PrivilegioCongr",
            ...
            //     columns: table => new
            //     {
            //         Id = table.Column<long>(nullable: false, defaultValueSql: "nextval('secretary.\"ServicoCampo_Id_seq\"'::regclass)"),
            //         DateCreated = table.Column<DateTime>(nullable: false, defaultValueSql: "now()"),
            //         ModifiedDate = table.Column<DateTime>(nullable: false, defaultValueSql: "now()"),
            //         IPAddress = table.Column<string>(nullable: true),
            //         AnoReferencia = table.Column<int>(nullable: true),
            //         DataEntrega = table.Column<DateTime>(type: "timestamp(3) without time zone", nullable: false, defaultValueSql: "now()"),
            //         DataReferencia = table.Column<DateTime>(type: "timestamp(3) without time zone", nullable: false, defaultValueSql: "now()"),
            ...
            //         Observacao = table.Column<string>(nullable: true),
            //         PioneiroId = table.Column<long>(nullable: false, defaultValueSql: "1"),
            ...
            //         HorasBetel = table.Column<int>(nullable: false),
            //         CreditoHoras = table.Column<int>(nullable: false),
            //         CongregacaoId = table.Column<long>(nullable: false, defaultValueSql: "1"),
            //         PublicadorId = table.Column<long>(nullable: false, defaultValueSql: "1")
            //     },
            //     constraints: table =>
            ...
            //     columns: table => new
            //     {
            //         Id = table.Column<long>(nullable: false, defaultValueSql: "nextval('secretary.\"ServicoCampod_Id_seq\"'::regclass)"),
            //         DateCreated = table.Column<DateTime>(nullable: false, defaultValueSql: "now()"),
            //         ModifiedDate = table.Column<DateTime>(nullable: false, defaultValueSql: "now()"),
            //         IPAddress = table.Column<string>(nullable: true),
            ...
            //     columns: table => new
            //     {
            //         Id = table.Column<long>(nullable: false, defaultValueSql: "nextval('secretary.\"ServicoCampos_Id_seq\"'::regclass)"),
            //         DateCreated = table.Column<DateTime>(nullable: false, defaultValueSql: "now()"),
            //         ModifiedDate = table.Column<DateTime>(nullable: false, defaultValueSql: "now()"),
            //         IPAddress = table.Column<string>(nullable: true),
            //         Estudos = table.Column<double>(nullable: false),
            ...
            //     columns: table => new
            //     {
            //         Id = table.Column<long>(nullable: false, defaultValueSql: "nextval('secretary.\"ServicoCampot_Id_seq\"'::regclass)"),
            //         DateCreated = table.Column<DateTime>(nullable: false, defaultValueSql: "now()"),
            //         ModifiedDate = table.Column<DateTime>(nullable: false, defaultValueSql: "now()"),
            //         IPAddress = table.Column<string>(nullable: true),
            //         Estudos = table.Column<double>(nullable: false),
            ...
            //     columns: table => new
            //     {
            //         Id = table.Column<long>(nullable: false, defaultValueSql: "nextval('secretary.\"Transferencia_Id_seq\"'::regclass)"),
            //         DateCreated = table.Column<DateTime>(type: "timestamp(3) without time zone", nullable: false, defaultValueSql: "now()"),
            //         ModifiedDate = table.Column<DateTime>(nullable: false, defaultValueSql: "now()"),
            //         IPAddress = table.Column<string>(nullable: true),
            //         AuditoriaUsuario = table.Column<long>(nullable: false, defaultValueSql: "1"),
            ...
            //         CongregacaoId = table.Column<long>(nullable: false, defaultValueSql: "1"),
            //         PublicadorId = table.Column<long>(nullable: false, defaultValueSql: "1"),
            //         OrigemId = table.Column<long>(nullable: false, defaultValueSql: "1"),
            //         DestinoId = table.Column<long>(nullable: false, defaultValueSql: "1")
            //     },
            //     constraints: table =>
            //     {
            ...
            //     columns: table => new
            //     {
            //         Id = table.Column<long>(nullable: false, defaultValueSql: "nextval('secretary.\"usuario_Id_seq\"'::regclass)"),
            //         DateCreated = table.Column<DateTime>(nullable: false, defaultValueSql: "now()"),
            //         ModifiedDate = table.Column<DateTime>(nullable: false, defaultValueSql: "now()"),
            //         IPAddress = table.Column<string>(nullable: true),
            //         Username = table.Column<string>(maxLength: 255, nullable: false, defaultValueSql: "0"),
            //         Email = table.Column<string>(nullable: true),
            //         CongregacaoId = table.Column<long>(nullable: true),
            //         PublicadorId = table.Column<long>(nullable: true, defaultValueSql: "0"),
            //         PasswordHarsh = table.Column<byte[]>(nullable: false, defaultValueSql: "'\\x'::bytea"),
            //         PasswordSalt = table.Column<byte[]>(nullable: false, defaultValueSql: "'\\x'::bytea")
            //     },
            //     constraints: table =>
            //     {
            ...
            //             onDelete: ReferentialAction.Restrict);
            //         table.ForeignKey(
            //             name: "FK_usuario_Publicador_PublicadorId",
            //             column: x => x.PublicadorId,
            //             principalSchema: "secretary",
            //             principalTable: "Publicador",
            //             principalColumn: "Id",
