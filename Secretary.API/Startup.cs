...
using Secretary.API.InterfacesImpl;
...
namespace Secretary.API
{
  public class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      // services.AddDbContext<ApplicationDbContext>(optionsAction =>
      // optionsAction.UseNpgsql(Configuration.GetConnectionString("DefaultConnectionProd")));
      ...
      services.AddScoped<ISituationRepository, SituationService>();
