...
{
    public partial class afterCountry : Migration
    {
 ...
 */
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Observacao = table.Column<string>(maxLength: 255, nullable: true),
                    EstaAprovado = table.Column<bool>(type: "boolean", nullable: false, defaultValueSql: "FALSE"),
                    CongregacaoId = table.Column<long>(nullable: false),
                    PublicadorId = table.Column<long>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PasswordHarsh = table.Column<byte[]>(maxLength: 255, nullable: false),
